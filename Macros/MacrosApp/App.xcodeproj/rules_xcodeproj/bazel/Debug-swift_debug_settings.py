...
_SETTINGS = {
	"arm64-apple-ios-simulator App.app/App": {
		"c": "-iquote$(PROJECT_DIR) -iquote$(PROJECT_DIR)/bazel-out/ios_sim_arm64-dbg-ios-sim_arm64-min15.0-applebin_ios-ST-01fde4593019/bin -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all"
	},
	"arm64-apple-ios-simulator Tests.xctest/Tests": {
		"c": "-iquote$(PROJECT_DIR) -iquote$(PROJECT_DIR)/bazel-out/ios_sim_arm64-dbg-ios-sim_arm64-min15.0-applebin_ios-ST-01fde4593019/bin -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all"
	}
}
